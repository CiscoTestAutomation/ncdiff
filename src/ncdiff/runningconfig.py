...
ORDERLESS_COMMANDS = [
    ...
    (re.compile(r'^ *crypto tls-tunnel '), 0),
    ...
    (re.compile(r'^ *domain-name '), 1),
    (re.compile(r'^ *option '), 1),
    ...
    (re.compile(r'^ *ip pim rp-address '), 0),
    (re.compile(r'^ *ipv6 pim rp-address '), 0),
    ...
    (re.compile(r'^ *device classifier '), 0),
    (re.compile(r'^ *\S+ tlv-type '), 1),
    (re.compile(r'^ *mac Regex '), 1),
